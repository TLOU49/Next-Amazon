...
const Cart = () => {
  ...
  return (
    <div className='flex max-w-screen-2xl mx-auto px-6 grid-cols-5 gap-10 py-4'>
      {
        ...
        <div className='bg-white h-64 col-span-5 p-4 rounded-lg flex items-center justify-center'>
          <CartPayment/>
        </div>
